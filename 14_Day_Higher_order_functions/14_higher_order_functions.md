#functions #higher-order #map #filter #reduce #lambda
...
```py
# Filter long name
names = ['Ayoub', 'Lidiya', 'Ermias', 'Abraham']  # iterable
...
1. Use reduce to concatenate all the countries and to produce this sentence: Estonia, Algeria, Sweden, Denmark, Norway, and Iceland are north European countries
1. Declare a function called categorize_countries that returns a list of countries with some common pattern (you can find the [countries list](https://github.com/Ayoub/Python-Bootcamp/blob/master/data/countries.py) in this repository as countries.js(eg 'land', 'ia', 'island', 'stan')).
