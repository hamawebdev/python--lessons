#advanced #errors #debugging #type-errors #troubleshooting

# 📘 Day 15 - Python Type Errors

[[14_Day_Higher_order_functions/14_higher_order_functions|← Day 14 - Higher Order Functions]] | [[16_Day_Exception_handling/16_exception_handling|Day 16 - Exception Handling →]]
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> user = {'name':'Ayoub', 'age':250, 'country':'Algeria'}
>>> user['name']
'Asab'
>>> user['county']
Traceback (most recent call last):
