#control-flow #conditionals #if-statements #decision-making
...
```
     ...
     * If the person is married and if he lives in Algeria, print the information in the following format:

```py
    Ayoub Hamadouche lives in Algeria. He is married.
```
