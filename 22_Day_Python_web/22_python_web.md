#web-development #flask #django #web-frameworks #backend

# 📘 Day 22 - Python for Web

[<< Day 21](../21_Day_Virtual_environment/21_virtual_environment.md) | [Day 23 >>](../23_Day_Python_with_mongodb/23_python_with_mongodb.md)
...
def home ():
    ...
    name = 'Python Bootcamp Programming'
