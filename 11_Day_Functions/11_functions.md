...
[[10_Day_Loops/10_loops|← Day 10 - Loops]] | [[12_Day_Modules/12_modules|Day 12 - Modules →]]
...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Ayoub','Hamadouche'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Ayoub', lastname = 'Hamadouche'))
...
def print_name(firstname):
    return firstname
print_name('Ayoub') # Ayoub

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Ayoub', lastname='Hamadouche')
```
...
def generate_full_name (first_name = 'Ayoub', last_name = 'Hamadouche'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
**Prerequisites**:
- [[02_Day_Variables_builtin_functions/02_variables_builtin_functions|Variables & Built-in Functions]]
- [[09_Day_Conditionals/09_conditionals|Conditionals]]
- [[10_Day_Loops/10_loops|Loops]]

**Next Steps**:
- [[12_Day_Modules/12_modules|Modules]] - Organize your functions
- [[14_Day_Higher_order_functions/14_higher_order_functions|Higher Order Functions]] - Advanced function concepts

**Uses Functions**:
- [[13_Day_List_comprehension/13_list_comprehension|List Comprehension]] - Functions in comprehensions
- [[16_Day_Exception_handling/16_exception_handling|Exception Handling]] - Functions with error handling
- [[19_Day_Classes_and_objects/19_classes_and_objects|Classes & Objects]] - Methods are functions in classes

**Data Processing with Functions**:
- [[05_Day_Lists/05_lists|Lists]] - Functions that work with lists
- [[08_Day_Dictionaries/08_dictionaries|Dictionaries]] - Functions that process dictionaries
- [[17_Day_File_handling/17_file_handling|File Handling]] - Functions for file operations
