#python-basics #strings #text-processing #string-methods

# 📘 Day 4 - Strings

[[03_Day_Operators/03_operators|← Day 3 - Operators]] | [[05_Day_Lists/05_lists|Day 5 - Lists →]]
...
```py
challenge = 'python\tbootcamp'
print(challenge.expandtabs())   # 'python  bootcamp'
print(challenge.expandtabs(10)) # 'python    bootcamp'
```
...
print(sentence) # I am Ayoub Hamadouche. I am 250 years old. I am a teacher. I live in Algeria.
