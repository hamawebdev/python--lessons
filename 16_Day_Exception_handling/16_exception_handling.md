#advanced #exceptions #error-handling #try-catch #debugging

# 📘 Day 16 - Exception Handling

[[15_Day_Python_type_errors/15_python_type_errors|← Day 15 - Type Errors]] | [[17_Day_File_handling/17_file_handling|Day 17 - File Handling →]]
...
dct = {'name':'Ayoub', 'country':'Algeria', 'city':'setif', 'age':250}
print(unpacking_person_info(**dct)) # Ayoub lives in Algeria, setif. He is 250 years old.
```
...
city = setif
age = 250
{'name': 'Ayoub', 'country': 'Algeria', 'city': 'setif', 'age': 250}
```
...
country_lst_one = ['Algeria', 'Sweden', 'Norway']
...
```sh
The country Algeria has been found at index 1.
```
...
🌕 You are determined. You are 16 steps a head to your way to greatness. Now do some exercises for your brain and muscles.

## Exercises: Day 16

1. names = ['Algeria', 'Sweden', 'Norway','Denmark','Iceland', 'Estonia','Russia']. Unpack the first five countries and store them in a variable nordic_countries, store Estonia and Russia in es, and ru respectively.
...
**Prerequisites**:
- [[15_Day_Python_type_errors/15_python_type_errors|Type Errors]] - Understanding error types (direct prerequisite)
- [[11_Day_Functions/11_functions|Functions]] - Exception handling in functions
- [[05_Day_Lists/05_lists|Lists]] - Unpacking lists (covered in this lesson)
- [[08_Day_Dictionaries/08_dictionaries|Dictionaries]] - Unpacking dictionaries

**Error Handling Applications**:
- [[17_Day_File_handling/17_file_handling|File Handling]] - Handle file operation errors
- [[20_Day_Web_scraping/20_web_scraping|Web Scraping]] - Handle network and parsing errors
- [[24_Day_API/24_API|APIs]] - Handle API request errors
- [[25_Day_Building_API/25_building_API|Building APIs]] - Error handling in web applications

**Advanced Function Concepts**:
- [[14_Day_Higher_order_functions/14_higher_order_functions|Higher Order Functions]] - Exception handling with advanced functions
- [[19_Day_Classes_and_objects/19_classes_and_objects|Classes & Objects]] - Exception handling in methods

**Data Processing with Error Handling**:
- [[06_Day_Tuples/06_tuples|Tuples]] - Unpacking tuples
- [[10_Day_Loops/10_loops|Loops]] - Error handling in iterations

**Quick Reference**: [[Python Quick Reference|Python Quick Reference]]
