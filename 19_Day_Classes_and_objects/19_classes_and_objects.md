#advanced #oop #classes #objects #inheritance

# 📘 Day 19 - Classes and Objects

[[18_Day_Python_package_manager/18_python_package_manager|← Day 18 - Package Manager]] | [[20_Day_Web_scraping/20_web_scraping|Day 20 - Web Scraping →]]
...
p = Person('Ayoub', 'Hamadouche', 250, 'Algeria', 'setif')
print(p.firstname)
print(p.lastname)
print(p.age)
print(p.country)
...
```sh
# output
Ayoub Hamadouche is 250 years old. He lives in setif, Algeria
```
...
```py
class Person:
      def __init__(self, firstname='Ayoub', lastname='Hamadouche', age=250, country='Algeria', city='setif'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
...
```py
class Student(Person):
    def __init__ (self, firstname='Ayoub', lastname='Hamadouche',age=250, country='Algeria', city='setif', gender='male'):
        self.gender = gender
...
**Prerequisites**:
- [[02_Day_Variables_builtin_functions/02_variables_builtin_functions|Variables & Built-in Functions]] - Understanding data types
- [[11_Day_Functions/11_functions|Functions]] - Methods are functions in classes
- [[08_Day_Dictionaries/08_dictionaries|Dictionaries]] - Object attributes are like dictionaries

**Object-Oriented Programming Concepts**:
- [[15_Day_Python_type_errors/15_python_type_errors|Type Errors]] - Understanding object types
- [[16_Day_Exception_handling/16_exception_handling|Exception Handling]] - Error handling in methods

**Data Structures in Classes**:
- [[05_Day_Lists/05_lists|Lists]] - Using lists as class attributes
- [[08_Day_Dictionaries/08_dictionaries|Dictionaries]] - Object-like data structures

**Advanced Applications**:
- [[17_Day_File_handling/17_file_handling|File Handling]] - Classes for file operations
- [[25_Day_Building_API/25_building_API|Building APIs]] - Classes in web applications
