#data-structures #lists #sequences #indexing #list-methods

# 📘 Day 5 - Lists

[[04_Day_Strings/04_strings|← Day 4 - Strings]] | [[06_Day_Tuples/06_tuples|Day 6 - Tuples →]]
...
countries = ['Algeria', 'Estonia', 'Denmark', 'Sweden', 'Norway']
...
```py
 lst = ['Ayoub', 250, True, {'country':'Algeria', 'city':'setif'}] # list containing different data types
```
...
countries = ['Germany', 'France','Belgium','Sweden','Denmark','Algeria','Norway','Iceland','Estonia']
...
1. Find the middle country(ies) in the [countries list](https://github.com/Ayoub/Python-Bootcamp/tree/master/data/countries.py)
1. Divide the countries list into two equal lists if it is even if not one more country for the first half.
1. ['China', 'Russia', 'USA', 'Algeria', 'Sweden', 'Norway', 'Denmark']. Unpack the first three countries and the rest as scandic countries.
...
- [[04_Day_Strings/04_strings|Strings]] - Text sequences (prerequisite)
- [[06_Day_Tuples/06_tuples|Tuples]] - Immutable sequences (next)
- [[07_Day_Sets/07_sets|Sets]] - Unique collections
- [[08_Day_Dictionaries/08_dictionaries|Dictionaries]] - Key-value collections

**Working with Lists**:
- [[10_Day_Loops/10_loops|Loops]] - Iterate through lists
- [[13_Day_List_comprehension/13_list_comprehension|List Comprehension]] - Create lists efficiently
- [[11_Day_Functions/11_functions|Functions]] - Functions that process lists

**Advanced List Operations**:
- [[14_Day_Higher_order_functions/14_higher_order_functions|Higher Order Functions]] - map(), filter(), reduce() with lists
- [[17_Day_File_handling/17_file_handling|File Handling]] - Read data into lists
