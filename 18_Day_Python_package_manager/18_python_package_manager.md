#advanced #pip #packages #virtual-env #dependencies

# 📘 Day 18 - Python Package Manager (PIP)

[<< Day 17](../17_Day_File_handling/17_file_handling.md) | [Day 19 >>](../19_Day_Classes_and_objects/19_classes_and_objects.md)
...
Create a new folder named mypacakge inside PythonBootcamp folder
...
def greet_person(firstname, lastname):
    return f'{firstname} {lastname}, welcome to Python bootcamp Challenge!'
```
...
```sh
ayoub@Ayoub:~/Desktop/PythonBootcamp$ python
Python 3.9.6 (default, Jun 28 2021, 15:26:21)
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
...
>>> greet.greet_person('Ayoub', 'Hamadouche')
'Ayoub Hamadouche, welcome to Python bootcamp Challenge!'
>>>
```
...
🌕 You are always progressing and you are a head of 18 steps to your way to greatness. Now do some exercises for your brain and muscles.
