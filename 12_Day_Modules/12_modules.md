#functions #modules #imports #code-organization
...
# main.py file
import mymodule
print(mymodule.generate_full_name('Ayoub', 'Hamadouche')) # Ayoub Hamadouche
```
...
print(generate_full_name('Ayoub','Hamadouche'))
...
print(fullname('Ayoub','Hamadouche'))
print(total(1, 9))
mass = 100;
weight = mass * g
print(weight)
