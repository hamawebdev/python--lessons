#python-basics #operators #arithmetic #comparison #logical

# 📘 Day 3 - Operators

[[02_Day_Variables_builtin_functions/02_variables_builtin_functions|← Day 2 - Variables & Built-in Functions]] | [[04_Day_Strings/04_strings|Day 4 - Strings →]]
...
print('A in Ayoub', 'A' in 'Ayoub') # True - A found in the string
print('B in Ayoub', 'B' in 'Ayoub') # False - there is no uppercase B
