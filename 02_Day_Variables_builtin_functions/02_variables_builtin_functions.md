#python-basics #variables #built-in-functions #data-types

# 📘 Day 2 - Variables, Builtin Functions

[[01_Day_Introduction/01_introduction|← Day 1 - Introduction]] | [[03_Day_Operators/03_operators|Day 3 - Operators →]]
...
1. Inside PythonBootcamp create a folder called day_2. Inside this folder create a file named variables.py
2. Write a python comment saying 'Day 2: Python bootcamp programming'
...
**Prerequisites**: [[01_Day_Introduction/01_introduction|Introduction to Python]]

**Next Steps**:
- [[03_Day_Operators/03_operators|Operators]] - Work with your variables
- [[04_Day_Strings/04_strings|Strings]] - Text data type in detail
- [[05_Day_Lists/05_lists|Lists]] - Collection data type

**Advanced Applications**:
- [[15_Day_Python_type_errors/15_python_type_errors|Type Errors]] - Understanding variable types
- [[11_Day_Functions/11_functions|Functions]] - Using variables in functions
